...
def get_mlf_data():
    """Get MLF registry data for the dashboard"""
    try:
        return mlf_integration.get_mlf_stats()
    except Exception as e:
        print(f"Error getting MLF data: {e}")
        return {}
